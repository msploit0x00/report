...
def get_columns():
    return [
        ...
        {"label": _("Company Name"), "fieldname": "customer_name", "fieldtype": "Link", "options": "Customer", "width": 120},
        ...
        {"label": _("Member Name English"), "fieldname": "customer_name_english", "fie  ldtype": "Data", "width": 300},
        {"label": _("CEO/Owner Name"), "fieldname": "custom_name_of_the_cioowner_of_the_company", "fieldtype": "Data", "width": 350},
        {"label": _("CEO/Owner Name English"), "fieldname": "custom_name_of_the_cioowner_of_the_company_in_english", "fieldtype": "Data", "width": 350},
...
def get_customer(filters):
    ...
    sql = """
        SELECT 
            ...
            `tabCustomer Activity`.`activity_type` AS `activity_type`,
